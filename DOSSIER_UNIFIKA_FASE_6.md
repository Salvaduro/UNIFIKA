...
2. **Reversión de Cierres (Override):** Facultad exclusiva del STAFF (ADMINISTRADOR/SUPERADMIN) para desbloquear nóminas.
3. **Pre-liquidación Automática:** Clonación de la nómina anterior con envío de notificaciones (Email/WhatsApp) para aprobación por omisión.
4. **Motor de Prestaciones:** Prototipado del cálculo de Primas y Cesantías.
...
- **Trazabilidad de Auditoría:** Si un Administrador reabre una nómina, la acción debe quedar registrada (requerirá a futuro tabla de logs o actualización de campos de auditoría).
